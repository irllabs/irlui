...
import UserProfile, { UserProfileProps } from '../components/user-profile/user-profile';
import {defaultTheme} from '../theme/create-theme';
import {Project} from '../components/user-profile/project-card/project-card'
...
Default.args = {
  ...
  getAllProjectsForUser: getProgects,
  openProject: () => {},
  saveProjectToFile: () => {},
  signOut: () => {}
};
